...
public class AuthorizationResponseDTO {
    ...
    public AuthorizationResponseDTO(Map<String, Object> map){
        if(map != null && map.size() > 0){
            ...
            if(map.containsKey("skype")) this.skype = (String) map.get("skype");
            if(map.containsKey("facebook")) this.facebook = (String) map.get("facebook");
            ...
            if(map.containsKey("lastLogin")) this.lastLogin = (Long) map.get("lastLogin");
            ...
            if(map.containsKey("fbId")) this.fbId = (String) map.get("fbId");
            if(map.containsKey("ggId")) this.ggId = (String) map.get("ggId");
            if(map.containsKey("setPassword")) this.setPassword = (Integer) map.get("setPassword");
            if(map.containsKey("profileUpdate")) this.profileUpdate = (Long) map.get("profileUpdate");
            if(map.containsKey("avatarUpdate")) this.avatarUpdate = (Long) map.get("avatarUpdate");
            if(map.containsKey("appleId")) this.appleId = (String) map.get("appleId");
        }
    }
