 ...
 */
package com.elcom.notify.utils;
...
//        Date tomorrow = new Date(today.getTime() + (1000 * 60 * 60 * 24 * 15));
        //System.out.println( createToken("meet.elcomvideo.cf", "meet.elcomvideo.cf", "*", "room", "*", "Elcom@123", tomorrow) );
        //System.out.println( JWTutils.createToken(InterviewConstant.JITSI_AUTH_ISS, InterviewConstant.JITSI_AUTH_SUB,
