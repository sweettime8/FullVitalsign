...
public class RpcConfig {
    ...
    @Value("${vs.notify.rpc.exchange}${tech.env}")
    private String rpcExchange;
    
    @Value("${vs.notify.rpc.queue}${tech.env}")
    private String rpcQueue;
    
    @Value("${vs.notify.rpc.key}${tech.env}")
    private String rpcKey;

    @Bean("vitalSignNotifyRpcQueue")
    @Primary
